...
void loop()
{
  ...
  else
  {
    ...
    {                     // 4:00 AM
      ...
      myservo2.write(0); 
      updateServo2State(false); // Rotate the pesticide servo back to 0 degrees to stop spraying
...
void updateServo1State(bool state)
{
  ...
  {
    HTTPClient http;
    String url = "https://uas-iot-25b4f-default-rtdb.firebaseio.comp/servo3.json";
...
void updateServo2State(bool state)
{
  ...
  {
    HTTPClient http;
    String url = "https://coba-e6c01-default-rtdb.asia-southeast1.firebasedatabase.app/servo4.json";
